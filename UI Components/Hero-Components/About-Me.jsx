  ...
  return (
    ...
    >
      ...
      <p className="text-gray-400 text-lg mb-12 max-w-2xl text-center">
        Hi,My name is Chukwuebuka Aniugo, I’m a passionate frontend developer
        who loves building clean, interactive, and also map-driven web apps. My
        focus is on crafting modern UIs with React, Leaflet, and smart motion
        design.
      </p>
